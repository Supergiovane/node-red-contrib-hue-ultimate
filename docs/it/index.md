...
Questa beta è pubblica e installabile da tutti. Esegui il comando seguente nella cartella utente di Node-RED (di solito `~/.node-red`), poi riavvia Node-RED. Servono Node.js 20.18.1 o successivo e Node-RED 3.1.1 o successivo. Installa `node-red-contrib-knx-ultimate` solo se vuoi l’integrazione KNX.
