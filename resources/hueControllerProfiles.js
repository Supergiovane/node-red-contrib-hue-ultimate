...
(function (root, factory) {
  ...
  if (root) root.HueStandaloneKNXUltimateHueControllerProfiles = api
  ...
  const PROFILE_FACTORIES = {
      ...
      (function () {
        RED.nodes.registerType('knxUltimateHueLight', {
          ...
          defaults: {
            ...
            serverHue: { type: 'hue-ultimate-config', required: true },
            name: { value: '' },
          ...
          oneditprepare: function () {
            ...
            function onEditPrepare () {
              ...
              const performLocateRequest = ({ silent = false, allowStoredContext = false, action } = {}) => {
                ...
                const request = $.ajax({
                  type: 'POST',
                  url: 'hueUltimate/KNXUltimateLocateHueDevice',
                  data: {
              ...
              const updateTabsVisibility = () => {
                ...
                // Mapping tabs are shared by KNX and Topic mode.
              ...
              const fetchHueDevices = (term, respond, { forceRefresh = false } = {}) => {
                ...
                $.getJSON(`hueUltimate/KNXUltimateGetResourcesHUE?rtype=light&serverId=${encodeURIComponent(hueServer.id)}${refreshQuery}&_=${Date.now()}`, (data) => {
              ...
              $(document)
                ...
                .on('change.knxUltimateHueLightGateway', '#node-input-server', function (event) {
                  ...
                  const normalizedValue = selectedValue === undefined || selectedValue === null
                    ? ''
                    : String(selectedValue).trim()
                  const selectionApi = window.HueStandaloneKNXUltimateHueControllerEditorSelection
              ...
              $('#getColorAtSwitchOnDayTimeButton').on('click', function () {
                ...
                let jRet
                let sQuery
                if ($('#node-input-specifySwitchOnBrightness').val() === 'yes') sQuery = 'hueUltimate/knxUltimateGetHueColor'
                if ($('#node-input-specifySwitchOnBrightness').val() === 'temperature') sQuery = 'hueUltimate/knxUltimateGetKelvinColor'
              ...
              $('#getColorAtSwitchOnNightTimeButton').on('click', function () {
                ...
                let jRet
                let sQuery
                if ($('#node-input-enableDayNightLighting').val() === 'yes') sQuery = 'hueUltimate/knxUltimateGetHueColor'
                if ($('#node-input-enableDayNightLighting').val() === 'temperature') sQuery = 'hueUltimate/knxUltimateGetKelvinColor'
        ...
        RED.nodes.registerType('knxUltimateHuePlug', {
          ...
          oneditprepare () {
            ...
            function fetchDevices (hueServer, term, response, { forceRefresh = false } = {}) {
              ...
              const refreshQuery = forceRefresh ? '&forceRefresh=1' : ''
              $.getJSON(`hueUltimate/KNXUltimateGetResourcesHUE?rtype=plug&serverId=${encodeURIComponent(hueServer.id)}${refreshQuery}&_=${Date.now()}`, (data) => {
    ...
    "button": function (RED) {
      ...
      (function () {
        ...
        const applyNoDevicesPlaceholder = (hasDevices) => {
          ...
          const message = RED._('node-red-contrib-hue-ultimate/knxUltimateHueButton:knxUltimateHueButton.no_devices')
        ...
        const fetchDevices = (hueServer, term, response, { forceRefresh = false } = {}) => {
          ...
          const refreshQuery = forceRefresh ? '&forceRefresh=1' : ''
          $.getJSON(`hueUltimate/KNXUltimateGetResourcesHUE?rtype=button&serverId=${encodeURIComponent(hueServer.id)}${refreshQuery}&_=${Date.now()}`, (data) => {
            const listCandidates = Array.isArray(data) ? data : (Array.isArray(data?.devices) ? data.devices : [])
            cachedDevices = listCandidates.map((value) => {
              if (value.deviceObject) return value
              return {
            ...
            if (ui.dimSendInput) {
              ui.dimSendInput.typedInput({
                ...
                types: [{
                  value: 'direction',
                  options: [
                    { value: 'up', label: RED._('node-red-contrib-hue-ultimate/knxUltimateHueButton:knxUltimateHueButton.dim_up') || 'Up' },
                    { value: 'down', label: RED._('node-red-contrib-hue-ultimate/knxUltimateHueButton:knxUltimateHueButton.dim_down') || 'Down' },
                    { value: 'stop', label: RED._('node-red-contrib-hue-ultimate/knxUltimateHueButton:knxUltimateHueButton.dim_stop') || 'Stop' }
                  ]
                }]
              })
    ...
    "relative_rotary": function (RED) {
      ...
      (function () {
        ...
        const applyNoDevicesPlaceholder = (hasDevices) => {
          ...
          const noDevicesText = RED._('node-red-contrib-hue-ultimate/knxUltimateHueTapDial:knxUltimateHueTapDial.no_devices')
          if (hasDevices) {
            if (showingNoDevicesPlaceholder) {
        ...
        const fetchDevices = (hueServer, term, response, { forceRefresh = false } = {}) => {
          ...
          const refreshQuery = forceRefresh ? '&forceRefresh=1' : ''
          $.getJSON(`hueUltimate/KNXUltimateGetResourcesHUE?rtype=relative_rotary&serverId=${encodeURIComponent(hueServer.id)}${refreshQuery}&_=${Date.now()}`, (data) => {
            const listCandidates = Array.isArray(data) ? data : (Array.isArray(data?.devices) ? data.devices : [])
            cachedDevices = listCandidates.map((value) => ({
              id: value.id || value.rid,
              name: value.name || value.metadata?.name || ''
        ...
        RED.nodes.registerType('knxUltimateHueTapDial', {
          ...
          icon: 'node-hue-icon.svg',
          label () {
            return `${this.name || RED._('node-red-contrib-hue-ultimate/knxUltimateHueTapDial:knxUltimateHueTapDial.paletteLabel')} (deprecated)`
          },
    ...
    "motion": function (RED) {
      ...
      (function () {
        ...
        const applyNoDevicesPlaceholder = (hasDevices) => {
          ...
          const message = RED._('node-red-contrib-hue-ultimate/knxUltimateHueMotion:knxUltimateHueMotion.no_devices')
          showingNoDevicesPlaceholder = true
        ...
        const fetchDevices = (hueServer, term, response, { forceRefresh = false } = {}) => {
          ...
          if ($loadingIndicator) $loadingIndicator.show()
          const refreshQuery = forceRefresh ? '&forceRefresh=1' : ''
          $.getJSON(`hueUltimate/KNXUltimateGetResourcesHUE?rtype=motion&serverId=${encodeURIComponent(hueServer.id)}${refreshQuery}&_=${Date.now()}`, (data) => {
            const listCandidates = Array.isArray(data) ? data : (Array.isArray(data?.devices) ? data.devices : [])
            cachedDevices = listCandidates.map((value) => ({
              id: value.id || value.rid,
              name: value.name || value.metadata?.name || '',
        ...
        RED.nodes.registerType('knxUltimateHueMotion', {
          ...
          icon: 'node-hue-icon.svg',
          label () {
            return `${this.name || RED._('node-red-contrib-hue-ultimate/knxUltimateHueMotion:knxUltimateHueMotion.paletteLabel')} (deprecated)`
          },
    ...
    "area_motion": function (RED) {
      ...
      (function () {
        ...
        const applyNoDevicesPlaceholder = (hasDevices) => {
          ...
          const message = RED._('node-red-contrib-hue-ultimate/knxUltimateHueAreaMotion:knxUltimateHueAreaMotion.no_devices')
          showingNoDevicesPlaceholder = true
          $deviceName.attr('placeholder', message)
          if (($deviceName.val() || '').trim() === '') {
            $deviceName.val('')
        ...
        const fetchDevices = (hueServer, term, response, { forceRefresh = false } = {}) => {
          ...
          if ($loadingIndicator) $loadingIndicator.show()
          const refreshQuery = forceRefresh ? '&forceRefresh=1' : ''
          $.getJSON(`hueUltimate/KNXUltimateGetResourcesHUE?rtype=area_motion&serverId=${encodeURIComponent(hueServer.id)}${refreshQuery}&_=${Date.now()}`, (data) => {
            const listCandidates = Array.isArray(data) ? data : (Array.isArray(data?.devices) ? data.devices : [])
            cachedDevices = listCandidates.map((value) => {
              if (value.deviceObject) return value
              return {
        ...
        RED.nodes.registerType('knxUltimateHueAreaMotion', {
          ...
          icon: 'node-hue-icon.svg',
          label () {
            return `${this.name || RED._('node-red-contrib-hue-ultimate/knxUltimateHueAreaMotion:knxUltimateHueAreaMotion.paletteLabel')} (deprecated)`
          },
    ...
    "camera_motion": function (RED) {
      ...
      (function () {
        ...
        const applyNoDevicesPlaceholder = (hasDevices) => {
          ...
          const message = RED._('node-red-contrib-hue-ultimate/knxUltimateHueCameraMotion:knxUltimateHueCameraMotion.no_devices')
          showingNoDevicesPlaceholder = true
          $deviceName.attr('placeholder', message)
          if (($deviceName.val() || '').trim() === '') {
            $deviceName.val('')
        ...
        const fetchDevices = (hueServer, term, response, { forceRefresh = false } = {}) => {
          ...
          if ($loadingIndicator) $loadingIndicator.show()
          const refreshQuery = forceRefresh ? '&forceRefresh=1' : ''
          $.getJSON(`hueUltimate/KNXUltimateGetResourcesHUE?rtype=camera_motion&serverId=${encodeURIComponent(hueServer.id)}${refreshQuery}&_=${Date.now()}`, (data) => {
            const listCandidates = Array.isArray(data) ? data : (Array.isArray(data?.devices) ? data.devices : [])
            cachedDevices = listCandidates.map((value) => {
              if (value.deviceObject) return value
              return {
    ...
    "contact": function (RED) {
      ...
      (function () {
        ...
        const EMPTY_SERVER_VALUES = new Set(['', 'none', '_add_', '__none__', '__null__', 'null', 'undefined'])
        const DEVICE_PLACEHOLDER_KEY = 'node-red-contrib-hue-ultimate/knxUltimateHueContactSensor:knxUltimateHueContactSensor.placeholders.device'
        const NO_DEVICES_KEY = 'node-red-contrib-hue-ultimate/knxUltimateHueContactSensor:knxUltimateHueContactSensor.no_devices'
        ...
        const fetchDevices = (hueServer, term, response, { forceRefresh = false } = {}) => {
          ...
          if ($loadingIndicator) $loadingIndicator.show()
          const refreshQuery = forceRefresh ? '&forceRefresh=1' : ''
          $.getJSON(`hueUltimate/KNXUltimateGetResourcesHUE?rtype=contact&serverId=${encodeURIComponent(hueServer.id)}${refreshQuery}&_=${Date.now()}`, (data) => {
            const listCandidates = Array.isArray(data) ? data : (Array.isArray(data?.devices) ? data.devices : [])
            cachedDevices = listCandidates.map((value) => {
              if (value.deviceObject) return value
              return {
    ...
    "light_level": function (RED) {
      ...
      (function () {
        ...
        const applyNoDevicesPlaceholder = (hasDevices) => {
          ...
          const message = RED._('node-red-contrib-hue-ultimate/knxUltimateHueLightSensor:knxUltimateHueLightSensor.no_devices')
          showingNoDevicesPlaceholder = true
          $deviceName.attr('placeholder', message)
        ...
        const fetchDevices = (hueServer, term, response, { forceRefresh = false } = {}) => {
          ...
          if ($loadingIndicator) $loadingIndicator.show()
          const refreshQuery = forceRefresh ? '&forceRefresh=1' : ''
          $.getJSON(`hueUltimate/KNXUltimateGetResourcesHUE?rtype=light_level&serverId=${encodeURIComponent(hueServer.id)}${refreshQuery}&_=${Date.now()}`, (data) => {
            const listCandidates = Array.isArray(data) ? data : (Array.isArray(data?.devices) ? data.devices : [])
            cachedDevices = listCandidates.map((value) => ({
              id: value.id || value.rid,
              name: value.name || value.metadata?.name || '',
    ...
    "temperature": function (RED) {
      ...
      (function () {
        ...
        const applyNoDevicesPlaceholder = (hasDevices) => {
          ...
          const message = RED._('node-red-contrib-hue-ultimate/knxUltimateHueTemperatureSensor:knxUltimateHueTemperatureSensor.no_devices')
          showingNoDevicesPlaceholder = true
          $deviceName.attr('placeholder', message)
          if (($deviceName.val() || '').trim() === '') $deviceName.val('')
        }
        ...
        const fetchDevices = (hueServer, term, response, { forceRefresh = false } = {}) => {
          ...
          if ($loadingIndicator) $loadingIndicator.show()
          const refreshQuery = forceRefresh ? '&forceRefresh=1' : ''
          $.getJSON(`hueUltimate/KNXUltimateGetResourcesHUE?rtype=temperature&serverId=${encodeURIComponent(hueServer.id)}${refreshQuery}&_=${Date.now()}`, (data) => {
            const listCandidates = Array.isArray(data) ? data : (Array.isArray(data?.devices) ? data.devices : [])
            cachedDevices = listCandidates.map((value) => ({
              id: value.id || value.rid,
              name: value.name || value.metadata?.name || '',
        ...
        RED.nodes.registerType('knxUltimateHueTemperatureSensor', {
          ...
          icon: 'node-hue-icon.svg',
          label () {
            return `${this.name || RED._('node-red-contrib-hue-ultimate/knxUltimateHueTemperatureSensor:knxUltimateHueTemperatureSensor.paletteLabel')} (deprecated)`
          },
    ...
    "humidity": function (RED) {
      ...
      (function () {
        ...
        const applyNoDevicesPlaceholder = (hasDevices) => {
          ...
          const message = RED._('node-red-contrib-hue-ultimate/knxUltimateHueHumiditySensor:knxUltimateHueHumiditySensor.no_devices')
          showingNoDevicesPlaceholder = true
          $deviceName.attr('placeholder', message)
          if (($deviceName.val() || '').trim() === '') {
            $deviceName.val('')
        ...
        const fetchDevices = (hueServer, term, response, { forceRefresh = false } = {}) => {
          ...
          if ($loadingIndicator) $loadingIndicator.show()
          const refreshQuery = forceRefresh ? '&forceRefresh=1' : ''
          $.getJSON(`hueUltimate/KNXUltimateGetResourcesHUE?rtype=humidity&serverId=${encodeURIComponent(hueServer.id)}${refreshQuery}&_=${Date.now()}`, (data) => {
            const listCandidates = Array.isArray(data) ? data : (Array.isArray(data?.devices) ? data.devices : [])
            cachedDevices = listCandidates.map((value) => {
              if (value.deviceObject) return value
              return {
    ...
    "scene": function (RED) {
      ...
      (function () {
        ...
        const applyNoDevicesPlaceholder = (hasDevices) => {
          if (!$deviceName) return
          const noDevicesText = RED._('node-red-contrib-hue-ultimate/knxUltimateHueScene:knxUltimateHueScene.no_scenes')
          if (!hasDevices) {
            if (!showingNoDevicesPlaceholder) {
              $deviceName.attr('placeholder', noDevicesText)
              showingNoDevicesPlaceholder = true
        ...
        const fetchScenes = (hueServer, term, reply, { forceRefresh = false } = {}) => {
          ...
          if ($loadingIndicator) $loadingIndicator.show()
          const refreshQuery = forceRefresh ? '&forceRefresh=1' : ''
          $.getJSON(`hueUltimate/KNXUltimateGetResourcesHUE?rtype=scene&serverId=${encodeURIComponent(hueServer.id)}${refreshQuery}&_=${Date.now()}`, (data) => {
          ...
          $list.editableList({
            ...
            addItem (container, i, opt) {
              ...
              const rowRuleHUESceneName = $('<input/>', {
                ...
                type: 'text',
                placeholder: RED._('node-red-contrib-hue-ultimate/knxUltimateHueScene:knxUltimateHueScene.multi_scene_placeholder'),
          ...
          oneditprepare () {
            ...
            try {
              ...
              try {
                ...
                RED.notify(RED._(
                  'node-red-contrib-hue-ultimate/knxUltimateHueScene:knxUltimateHueScene.editor_error',
    ...
    "device_power": function (RED) {
      ...
      (function () {
        ...
        const applyNoDevicesPlaceholder = (hasDevices) => {
          ...
          const message = RED._('node-red-contrib-hue-ultimate/knxUltimateHueBattery:knxUltimateHueBattery.no_devices')
          showingNoDevicesPlaceholder = true
          $deviceName.attr('placeholder', message)
          if (($deviceName.val() || '').trim() === '') {
            $deviceName.val('')
        ...
        const fetchDevices = (hueServer, term, response, { forceRefresh = false } = {}) => {
          ...
          if ($loadingIndicator) $loadingIndicator.show()
          const refreshQuery = forceRefresh ? '&forceRefresh=1' : ''
          $.getJSON(`hueUltimate/KNXUltimateGetResourcesHUE?rtype=device_power&serverId=${encodeURIComponent(hueServer.id)}${refreshQuery}&_=${Date.now()}`, (data) => {
            const listCandidates = Array.isArray(data) ? data : (Array.isArray(data?.devices) ? data.devices : [])
            cachedDevices = listCandidates.map((value) => ({
              id: value.id || value.rid,
              name: value.name || value.metadata?.name || '',
        ...
        RED.nodes.registerType('knxUltimateHueBattery', {
          ...
          icon: 'node-hue-icon.svg',
          label () {
            return `${this.name || RED._('node-red-contrib-hue-ultimate/knxUltimateHueBattery:knxUltimateHueBattery.paletteLabel')} (deprecated)`
          },
    ...
    "zigbee_connectivity": function (RED) {
      ...
      (function () {
        ...
        const applyNoDevicesPlaceholder = (hasDevices) => {
          ...
          const message = RED._('node-red-contrib-hue-ultimate/knxUltimateHueZigbeeConnectivity:knxUltimateHueZigbeeConnectivity.no_devices')
          showingNoDevicesPlaceholder = true
          $deviceName.attr('placeholder', message)
          if (($deviceName.val() || '').trim() === '') {
            $deviceName.val('')
        ...
        const fetchDevices = (hueServer, term, response, { forceRefresh = false } = {}) => {
          ...
          if ($loadingIndicator) $loadingIndicator.show()
          const refreshQuery = forceRefresh ? '&forceRefresh=1' : ''
          $.getJSON(`hueUltimate/KNXUltimateGetResourcesHUE?rtype=zigbee_connectivity&serverId=${encodeURIComponent(hueServer.id)}${refreshQuery}&_=${Date.now()}`, (data) => {
            const listCandidates = Array.isArray(data) ? data : (Array.isArray(data?.devices) ? data.devices : [])
            cachedDevices = listCandidates.map((value) => ({
              id: value.id || value.rid,
              name: value.name || value.metadata?.name || '',
        ...
        RED.nodes.registerType('knxUltimateHueZigbeeConnectivity', {
          ...
          icon: 'node-hue-icon.svg',
          label () {
            return `${this.name || RED._('node-red-contrib-hue-ultimate/knxUltimateHueZigbeeConnectivity:knxUltimateHueZigbeeConnectivity.paletteLabel')} (deprecated)`
          },
    ...
    "device_software_update": function (RED) {
      ...
      (function () {
        ...
        const applyNoDevicesPlaceholder = (hasDevices) => {
          if (!$deviceName) return
          const noDevicesText = RED._('node-red-contrib-hue-ultimate/knxUltimateHuedevice_software_update:knxUltimateHuedevice_software_update.no_devices')
          if (hasDevices) {
            if (showingNoDevicesPlaceholder) {
              $deviceName.attr('placeholder', defaultDevicePlaceholder)
              showingNoDevicesPlaceholder = false
        ...
        const fetchDevices = (hueServer, term, response, { forceRefresh = false } = {}) => {
          ...
          if ($loadingIndicator) $loadingIndicator.show()
          const refreshQuery = forceRefresh ? '&forceRefresh=1' : ''
          $.getJSON(`hueUltimate/KNXUltimateGetResourcesHUE?rtype=device_software_update&serverId=${encodeURIComponent(hueServer.id)}${refreshQuery}&_=${Date.now()}`, (data) => {
            const listCandidates = Array.isArray(data) ? data : (Array.isArray(data?.devices) ? data.devices : [])
            cachedDevices = listCandidates.map((value) => ({
              id: value.id || value.rid,
              name: value.name || value.metadata?.name || ''
        ...
        RED.nodes.registerType('knxUltimateHuedevice_software_update', {
          ...
          icon: 'node-hue-icon.svg',
          label () {
            return `${this.name || RED._('node-red-contrib-hue-ultimate/knxUltimateHuedevice_software_update:knxUltimateHuedevice_software_update.paletteLabel')} (deprecated)`
          },
  ...
  const CONTROLLER_LOCALE_KEY = 'node-red-contrib-hue-ultimate/hueUltimateController:hueUltimateController.locale'
  ...
  // Expose only the narrow API consumed by hueUltimateController.html and
