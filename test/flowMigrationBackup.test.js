...
describe('Flow migration backup', function () {
  ...
  it('serializes before browser callbacks or subsequent conversion can mutate exported objects', async function () {
    ...
    backup.nodes[0].type = 'hueUltimateController'
  ...
  it('exposes the same API in a plain browser script', function () {
    ...
    expect(context.HueStandaloneKNXUltimateFlowMigrationBackup.download).to.be.a('function')
    context.HueStandaloneKNXUltimateFlowMigrationBackup.download(backup.RED, { kind: 'hue' })
