...
## Philips Hue devices for Node-RED

One multimode HUE Controller for lights, groups, plugs, scenes, buttons and sensors. Choose a Hue resource and the node shows its supported functions. Controllers share a Hue Bridge configuration.
...
[npm-version-image]: https://img.shields.io/npm/v/node-red-contrib-hue-ultimate/beta.svg
